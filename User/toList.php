...
if(isset($_POST['SearchContent']) && $_POST['SearchContent']){
  ...
  $SearchColumn=TextFilter($SearchColumn);
  $SearchContent=TextFilter($SearchContent);
  
  $sql.=" WHERE $SearchColumn LIKE '%{$SearchContent}%'";
}
...
<div class="input-group">
  <div class="input-group-btn">
    <button type="button" id="showName" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">筛选条件 <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a onclick="selectSearchColumn('UserName','用户名')">用户名</a></li>
      <li><a onclick="selectSearchColumn('RealName','真实姓名')">真实姓名</a></li>
    </ul>
  </div>
...
<?php
  for($i=$Begin;$i<$Limit;$i++){
    ...
    $Roleinfo=PDOQuery($dbcon,"SELECT * FROM roles WHERE RoleID=?",[$RoleID],[PDO::PARAM_INT]);
