...
<div class="row">
  <div class="well col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center col-xs-10 col-xs-offset-1">
    ...
    <input class="form-control" id="UserName" autocomplete="off" onkeyup="if(event.keyCode==13)$('#Password')[0].focus();">
      ...
      <button class="btn btn-success" style="width:98%" onclick="toLogin()"> 登 录 Login </button>
...
window.onload=function(){
  ...
  /********** ▼ 记住密码 ▼ **********/
  Remember=getCookie("OT_YC_RMS_RmUN");
  if(Remember!=null){
...
function toLogin(){
  ...
  if(Remember==true){
    setCookie("OT_YC_RMS_RmUN",UserName);
  }else{
    delCookie("OT_YC_RMS_RmUN");
  }
  /********** ▲ 记住密码 ▲ **********/
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" onclick='isAjaxing=0;$("#myModal").modal("hide");'>返回 &gt;</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->